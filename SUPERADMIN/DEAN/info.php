...
<div d1>
	<a href='../superadminhome.php'><img src='redstar.png' logo /></a>
	<abbr uep>UEP</abbr>
	<span id='gateway'>SUPERADMIN</span>
	<div id='below'> 
		...
		<span log>
			...
			LOGGED: 
			<?php
			 echo''.$row["superadmin_lname"].' , '.$row["superadmin_fname"].' &nbsp '.$row["superadmin_mname"].'    '; 
			 echo" on " . date("Y/m/d");
