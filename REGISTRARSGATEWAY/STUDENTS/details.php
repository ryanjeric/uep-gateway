...
print "
	<table class='details'>
		...
		<a href='editstudent.php?sid=$IDNO' buttonlike>Edit</a>
		";
			if($data['status'] == 1) {
				$status = 'Deactivate';
			}
...
?>
		<a href='status.php?idno=<?php echo $IDNO; ?>' onclick="return confirm('Are you sure you want to <?php echo $status;?> this student?')" buttonlike>
<?php 
print "	$status</a>
		</td></tr>
		<tr>
