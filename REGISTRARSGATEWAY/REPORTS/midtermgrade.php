...
<div d2>
    <span class='divhead'>
    <a class='spanhead'>Midterm Grade</a>
    </span>
<br><br>
<?php
$TERM = $_GET['term'];
   ...
   print "<form method='POST'>
    ...
    if(mysqli_num_rows($sel_students) > 0) {
        ...
        echo "<td>$num<input type='hidden' name='student_id[]' value='$sid'></td>";
            ...
            $sel_studentgrade = mysqli_query("SELECT * FROM midtermgrade WHERE term = $TERM AND courseid = $course_ID AND studentid = $sid LIMIT 1");
