...
$Password=mysqli_real_escape_string($_POST['pass']);
	...
	{
	$result=mysqli_query("SELECT * FROM registrar where empid='$emp' and password='$Password' and designation='REGISTRAR' and status='ACTIVATE' or empid='$emp' and password='$Password' and designation='ASSISTANT CLERK' and status='ACTIVATE' LIMIT 1") or die(mysqli_error());
...
<div id='fixleft'>
	...
	<tr><td colspan='2'><h2>Registrar's LOG-IN..</h2></td></tr>
	<tr>
		<td class='first-col'>Employee ID:</td>
		<td><input type=number required title="NUMBERIC VALUE" name=empid class='inputs'></td>
	</tr>
